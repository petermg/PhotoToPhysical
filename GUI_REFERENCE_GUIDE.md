...
**Good default:**
`1260` is the GUI default for single-image processing. Lower it if GPU memory is limited or inference is too slow; raise it only when testing whether additional process resolution improves the depth result.
